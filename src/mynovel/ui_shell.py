...
def app_css() -> str:
    ...
    *{box-sizing:border-box}body{margin:0;background:var(--bg-canvas);color:var(--ink);font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;letter-spacing:0}a{color:inherit;text-decoration:none}
    ...
    .production-main{padding:24px}.chapter-production-layout .reader-panel,.human-review-layout .reader-panel{border-radius:8px}.chapter-task-board{display:grid;gap:18px}.chapter-stage-chain{display:flex;gap:12px;align-items:stretch;flex-wrap:wrap}.chapter-stage-link{width:28px;min-width:28px;height:2px;background:linear-gradient(90deg,#d8ddd3 0%,#c7d6c9 100%);align-self:center}.chapter-stage{flex:1 1 180px;display:grid;gap:8px;padding:16px;border:1px solid var(--line);border-radius:12px;background:#fff}.chapter-stage span{display:grid;place-items:center;width:30px;height:30px;border-radius:999px;border:1px solid currentColor;font-weight:800}.chapter-stage strong{font-size:15px}.chapter-stage em{font-style:normal;font-size:12px}.chapter-stage.done{color:var(--accent);background:#f7fbf7}.chapter-stage.current{color:var(--warn);background:#fff8ef;border-color:#efd2a7}.chapter-stage.pending{color:var(--muted)}.chapter-result-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.chapter-result-slot{border:1px solid var(--line);border-radius:12px;background:#fff;padding:16px;display:grid;gap:10px;min-height:174px}.chapter-result-slot.ready{background:#fbfdf9}.chapter-result-slot.pending{background:#f8f6ef}.chapter-result-slot header{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.chapter-result-slot header strong{font-size:16px}.chapter-result-slot header span{font-size:12px;color:var(--muted)}.chapter-slot-preview{min-width:0}.chapter-slot-preview p,.chapter-slot-preview ul,.chapter-slot-preview dl{margin:0}.chapter-slot-preview ul{padding-left:18px}.chapter-slot-preview dl{display:grid;grid-template-columns:76px 1fr;gap:6px 10px}.production-grid{grid-template-columns:1.15fr 1.45fr 1fr 1fr;gap:16px}.production-grid .data-card:nth-child(5),.production-grid .data-card:nth-child(6){grid-column:span 2}.review-decision-surface{display:grid;gap:18px}.review-summary-stack{display:grid;gap:12px;margin-bottom:8px}.review-summary-card{padding:16px 18px;border:1px solid var(--line);border-radius:12px;background:var(--panel-elevated)}.review-summary-card h2{margin-bottom:8px}.review-summary-card p:last-child{margin-bottom:0}.decision-question-list{display:grid;gap:8px;padding-left:18px;margin:0}.decision-question-list li{margin:0;line-height:1.6}.state-change-pill{display:inline-flex;align-items:center;padding:4px 8px;margin-right:8px;border-radius:999px;background:var(--accent-2);color:var(--accent-strong);font-size:12px;font-weight:700}.human-review-layout .chapter-text{font-size:20px;line-height:2.18;min-height:540px;border-top:1px solid var(--line);padding:24px 34px}.review-decision-panel{display:grid;grid-template-columns:1fr 1fr;gap:10px}.review-repair-form{grid-column:1 / -1}.review-repair-form textarea{min-height:124px}.review-tabs{grid-template-columns:repeat(4,1fr);margin:0 0 18px}.review-list li{border-radius:0;border-left:0;border-right:0;border-top:0}
