...
def app_css() -> str:
    return """
    :root{color-scheme:light;--bg:#fffefa;--panel:#fffefa;--panel-soft:#fbfcf8;--ink:#1d2822;--muted:#68756d;--line:#dfe5dc;--accent:#426f4e;--accent-2:#edf4ea;--warn:#c47a16;--warn-soft:#fff7ea;--danger:#b94435;--shadow:0 18px 50px rgba(29,40,34,.06)}
    *{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--ink);font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;letter-spacing:0}a{color:inherit;text-decoration:none}
    .app-shell{display:grid;grid-template-columns:144px 1fr;grid-template-rows:84px minmax(0,1fr);height:100vh;overflow:hidden}.topbar{grid-column:1 / -1;grid-row:1;border-bottom:1px solid var(--line);display:flex;align-items:center;justify-content:space-between;padding:0 32px;background:#fffefa}.brand{display:flex;align-items:center;gap:14px}.brand-mark{width:40px;height:40px;display:grid;place-items:center;color:var(--accent)}.brand-mark svg{width:40px;height:40px}.brand strong{font-size:26px;letter-spacing:0}.top-actions{display:flex;align-items:center;gap:22px;color:#2a332e;font-size:16px}.top-actions a{display:inline-flex;align-items:center;gap:8px}.top-separator{width:1px;height:30px;background:var(--line)}.icon-svg{width:24px;height:24px;fill:none;stroke:currentColor;stroke-width:1.9;stroke-linecap:round;stroke-linejoin:round}.rail{grid-column:1;grid-row:2;border-right:1px solid var(--line);background:#fffefa;display:flex;flex-direction:column;align-items:stretch;padding:18px 10px;gap:14px;min-height:0}.nav-stack,.nav-bottom{display:grid;gap:8px}.nav-bottom{margin-top:auto}.nav-item{position:relative;border-radius:8px;padding:13px 6px;display:grid;justify-items:center;gap:8px;color:#3f4844;font-size:16px}.nav-item.active,.nav-item:hover{background:var(--accent-2);color:var(--accent)}.nav-item.active:before{content:"";position:absolute;left:-10px;top:0;bottom:0;width:4px;background:var(--accent);border-radius:999px}.nav-icon{width:32px;height:32px;display:grid;place-items:center}.nav-icon .icon-svg{width:30px;height:30px;stroke-width:1.8}
    .workspace{grid-column:2;grid-row:2;display:flex;flex-direction:column;min-width:0;min-height:0;overflow:hidden}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}.notice{margin:16px 24px 0;color:var(--warn)}
    ...
    .pipeline{position:relative;min-height:214px;flex:0 0 214px;margin:0 194px 26px 24px;border:1px solid var(--line);border-radius:8px;background:#fffefa;display:grid;grid-template-columns:116px 1fr;align-items:start;gap:20px;padding:56px 30px 18px 18px;overflow:auto}.pipeline h2{position:absolute;left:18px;top:19px;margin:0;font-size:22px;display:flex;align-items:center;gap:8px}.pipeline-track{grid-column:2;display:flex;align-items:flex-start;gap:14px;margin:0;padding:0;list-style:none;min-width:max-content}.pipeline-step{width:120px;display:grid;justify-items:center;gap:5px;text-align:center;color:var(--muted);margin:0}.pipeline-step strong{font-size:17px;color:var(--ink)}.pipeline-step em{font-style:normal;font-size:14px}.pipeline-icon{width:54px;height:54px;border:1px solid var(--line);border-radius:999px;display:grid;place-items:center;background:#fff;font-size:24px}.pipeline-step.done{color:var(--accent)}.pipeline-step.done .pipeline-icon{background:var(--accent-2);border-color:var(--accent)}.pipeline-step.current{color:var(--warn)}.pipeline-step.current .pipeline-icon{background:var(--warn-soft);border-color:var(--warn)}.pipeline-step.locked .pipeline-icon{color:#38413d}.pipeline-step.locked em:before{content:"▣";font-size:11px;color:#9ca39e;margin-right:8px}.pipeline-connector{width:134px;border-top:2px dashed #c6cdc8;position:relative;margin-top:27px}.pipeline-connector:after{content:"";position:absolute;right:0;top:-5px;width:8px;height:8px;border-right:2px solid #c6cdc8;border-top:2px solid #c6cdc8;transform:rotate(45deg)}
    ...
    .production-main{padding:24px}.chapter-production-layout .reader-panel,.human-review-layout .reader-panel{border-radius:8px}.stage-control-grid{grid-template-columns:repeat(7,minmax(116px,1fr));gap:22px}.stage-card{min-height:182px;text-align:center;padding:20px}.stage-card span{margin:auto}.production-grid{grid-template-columns:1.15fr 1.45fr 1fr 1fr;gap:16px}.production-grid .data-card:nth-child(5),.production-grid .data-card:nth-child(6){grid-column:span 2}.human-review-layout .chapter-text{font-size:20px;line-height:2.18;min-height:540px;border-top:0;padding:24px 34px}.review-decision-panel{display:grid;grid-template-columns:1fr 1fr;gap:10px}.review-repair-form{grid-column:1 / -1}.review-repair-form textarea{min-height:124px}.review-tabs{grid-template-columns:repeat(4,1fr);margin:0 0 18px}.review-list li{border-radius:0;border-left:0;border-right:0;border-top:0}
    @media(max-width:1100px){.app-shell{grid-template-columns:82px minmax(0,1fr)}.brand strong{font-size:18px}.rail strong{font-size:13px}.content-grid,.first-launch-layout,.blueprint-layout,.content-grid.model-setup-layout,.content-grid.canon-gate-layout,.content-grid.production-layout{grid-template-columns:minmax(0,1fr)}.empty-hero,.reader-panel,.blueprint-actions{grid-column:auto}.blueprint-action-grid{grid-template-columns:minmax(0,1fr)}.form-grid,.card-grid,.state-sections,.blueprint-detail-grid,.proposal-grid,.split,.quality-grid,.canon-state-grid,.canon-summary-grid,.production-grid,.production-stage-grid,.impact-scope>div,.canon-preview-summary{grid-template-columns:minmax(0,1fr)}.model-field{grid-template-columns:minmax(0,1fr)}.model-field p{grid-column:auto}.model-check,.advanced-model-options{margin-left:0}.top-actions{display:none}.content-grid{padding:12px;overflow-x:hidden}.canon-gate-layout .right-panel{position:static;max-height:none;overflow:visible}.canon-completion-gate:not(.trusted){top:0}.canon-summary-card{padding-right:42px}.canon-preview-head{display:grid}.canon-preview-actions button{width:100%}.pipeline{grid-template-columns:minmax(0,1fr);margin:0 18px 18px;flex-basis:auto;min-height:180px}.pipeline-track{grid-column:1}.project-identity{grid-template-columns:64px minmax(0,1fr)}.project-cover{width:64px}.first-launch-layout{padding:18px}.first-launch-hero{min-height:420px;padding-top:42px}.launch-actions{width:min(360px,100%)}}
    """
